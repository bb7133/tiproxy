...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="cproute-migration-") as directory:
        ...
        cases = [
            ...
            ("final-offer-skips-source-validation", "selector.rs", "pub(crate) fn offer_redirect", "pub(crate) fn finish_redirect", [("self.sources.validate(&prepared.candidate)?;", "", 4)], "migration_final_lock_rechecks_config_routing_and_health"),
