...
def main():
    ...
    paths = [SOURCE, 'pkg/balance/router/selector_route_test.go',
    ...
    print('SELECTOR_ROUTE_MUTATIONS 4/4 compiled faults detected; baseline/restored and 4 witness corruptions passed', flush=True)
