...
runner.CASES = [
 ...
 go('failed-lease-admission-leaks-record', 'TestMixedEvaluationByteLimit', 'MIXED_FAILED_ATOMIC', [edit(REC, 'return false', 'r.records++; return false', 'func (r *Recorder) reserve(', 'func (r *Recorder) release(')]),
 ...
 go('capture-lease-double-release', 'TestEvaluationLeaseCloseAndInvalidationOwnership', 'MIXED_LEASE_RELEASE', [edit(LEASE, 'l.once.Do(func() { l.recorder.release(EvaluationCharge) })', 'l.recorder.release(EvaluationCharge)')]),
